...
var _loop = function _loop(i) {
  ...
  elem.addEventListener('click', function () {
    (0,_game__WEBPACK_IMPORTED_MODULE_0__.setLevelIndex)(i);
    hide(developerOverlay); // startNewGame();
...
for (var i = 0; i < _levels_json5__WEBPACK_IMPORTED_MODULE_1__.length; i++) {
  _loop(i);
